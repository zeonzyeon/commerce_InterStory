...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = -498877515L;
    ...
    public final com.app.interstory.novel.domain.QEpisode episode;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.episode = inits.isInitialized("episode") ? new com.app.interstory.novel.domain.QEpisode(forProperty("episode"), inits.get("episode")) : null;
