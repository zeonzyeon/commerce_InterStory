...
public class CommentController {
    ...
    public ResponseEntity<String> writeComment(@RequestBody CommentRequestDto requestDto, @PathVariable long episodeId, @AuthenticationPrincipal UserDetail userDetails) {
    ...
    public ResponseEntity<CommentListResponseDto> getEpisodeComment(@PathVariable Long episodeId, @RequestParam(defaultValue = "NEW_TO_OLD") Sort sort, @RequestParam(defaultValue = "1") Integer page, @AuthenticationPrincipal UserDetail userDetails) {
    ...
    public ResponseEntity<CommentListResponseDto> getNovelComment(@PathVariable Long novelId, @RequestParam(defaultValue = "NEW_TO_OLD") Sort sort, @RequestParam(defaultValue = "1") Integer page, @AuthenticationPrincipal UserDetail userDetails) {
    ...
    public ResponseEntity<Void> deleteComment(@PathVariable Long commentId, @AuthenticationPrincipal UserDetail userDetails) {
    ...
    public ResponseEntity<String> likeComment(@PathVariable Long commentId, @AuthenticationPrincipal UserDetail userDetails) {
